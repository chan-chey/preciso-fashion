      ...
      <div>
        <div className='section'>
          <Carousel className='hero-banner'>
            <Carousel.Item interval={1000} className='hero-banner-img'>
              <img
            ...
            <div className='product-wrap-one'>
              ...
              <div className='product-wrap'>
                ...
                <div className='product-text'>
                  ...
                  everywhere and to fulfill this goal, we design and curate a
                  wide variety of home décor and home furnishing products which
                  cater to different clients and brands worldwide. <br /> <br />
